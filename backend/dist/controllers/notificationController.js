...
import { listNotifications, countUnread, markOneRead, markAllRead, } from '../services/notificationService.js';
...
export const markOneReadHandler = asyncHandler(async (req, res) => {
    const userId = req.userId;
