...
class ShopOwnerOtpScreen extends StatefulWidget {
  final String phoneNumber;
  final int otpLength;

  const ShopOwnerOtpScreen({
    super.key,
    this.phoneNumber = '',
    this.otpLength = 6,
  });
  ...
  @override
  State<ShopOwnerOtpScreen> createState() => _ShopOwnerOtpScreenState();
}

class _ShopOwnerOtpScreenState extends State<ShopOwnerOtpScreen> {
  ...
  Future<void> _handleVerify() async {
    ...
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('OTP verified — delivery confirmed!'),
    ...
    Navigator.of(context).pushReplacement(
      MaterialPageRoute(builder: (context) => const ShopOwnerHomeScreen()),
    );
  }
